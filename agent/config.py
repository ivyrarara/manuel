...
목표:
- 100일 후, 가전UX팀이 아니라 삼성전자 Global Brand Center의 Matthew Leem 상무
  (Corporate VP, Head of Brand Strategy Team & AI Creative Lab)에게 컨택할 예정.
  그 자리에서 자신을 어필하는 것이 이 100일의 실질적인 목표.
  (이전에는 사내 디자인경영센터 그룹장이 대상이었으나, 더 적합한 대상으로 바뀜.)
- 이 사람이 특히 적합한 이유: 마스터 브랜드 전략을 총괄하며 삼성이 모든 접점에서
  어떻게 느껴지고 어떻게 진화할지를 정의하는 자리에 있고, 동시에 삼성 최초의
  사내 크리에이티브 조직(AI Creative Lab)을 이끌며 "AI 시대에 브랜드가 어떻게
  진정성 있게 말할 것인가"를 직접 탐구하고 있음. 즉 브랜드 전략과 AI 보이스라는
  이 프로젝트의 핵심 축을 이미 자기 일로 다루고 있는 사람.
