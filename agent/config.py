...
BLOG_CHECK_HOUR, BLOG_CHECK_MINUTE = 20, 30  # 체크인 30분 전에 미리 읽어둠
...
GITHUB_CHECK_HOUR, GITHUB_CHECK_MINUTE = 20, 40
...
CHECKIN_HOUR, CHECKIN_MINUTE = 21, 0

# 고정 리마인더
SUNDAY_REVIEW = (6, 19, 0)   # 일요일 19:00 — 이번 주 배운 것 + 삼킨 말 리뷰
MONDAY_ACTIONS = (0, 6, 30)  # 월요일 06:30 — 이번 주 액션 아이템
